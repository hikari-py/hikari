...
def calculate_waveform(audio_file_path: str) -> tuple[str, float]:
    ...
    # Author note: This is fancy maths that not even I understand,
    # but it is based off https://github.com/Vendicated/Vencord/blob/b3bff83dd5040950c55e09bed9e47a60490f81d8/src/plugins/voiceMessages/index.tsx#L145
