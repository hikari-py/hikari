...
class GuildRole(PartialGuildRole, marshaller.Serializable):
    ...
    permissions: permissions_.Permission = marshaller.attrib(
        deserializer=permissions_.Permission, serializer=int, default=permissions_.Permission(0), eq=False, hash=False
    )
...
class PresenceActivity(bases.Entity, marshaller.Deserializable):
    ...
    emoji: typing.Union[None, emojis_.UnicodeEmoji, emojis_.CustomEmoji] = marshaller.attrib(
        deserializer=emojis_.deserialize_reaction_emoji, if_undefined=None, default=None, inherit_kwargs=True
    )
...
) -> typing.Mapping[bases.Snowflake, emojis_.KnownCustomEmoji]:
    return {bases.Snowflake(emoji["id"]): emojis_.KnownCustomEmoji.deserialize(emoji, **kwargs) for emoji in payload}
...
class GuildPreview(PartialGuild):
    ...
    emojis: typing.Mapping[bases.Snowflake, emojis_.KnownCustomEmoji] = marshaller.attrib(
...
def _deserialize_channels(
    payload: more_typing.JSONArray, **kwargs: typing.Any
) -> typing.Mapping[bases.Snowflake, channels_.GuildChannel]:
    return {bases.Snowflake(channel["id"]): channels_.deserialize_channel(channel, **kwargs) for channel in payload}
...
class Guild(PartialGuild):  # pylint:disable=too-many-instance-attributes
    ...
    my_permissions: permissions_.Permission = marshaller.attrib(
        ...
        deserializer=permissions_.Permission,
        if_undefined=None,
        default=None,
        eq=False,
        hash=False,
    ...
    channels: typing.Optional[typing.Mapping[bases.Snowflake, channels_.GuildChannel]] = marshaller.attrib(
