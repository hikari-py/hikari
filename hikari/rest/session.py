...
class RESTSession(http_client.HTTPClient):  # pylint: disable=too-many-public-methods, too-many-instance-attributes
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        *,
        ...
        self.bucket_ratelimiters = buckets.RESTBucketManager()
    ...
    async def close(self) -> None:
        """Shut down the RESTSession client safely, and terminate any rate limiters executing in the background."""
    ...
    async def get_gateway_bot(self) -> more_typing.JSONObject:
        ...
        !!! note
            Unlike `RESTSession.get_gateway`, this requires a valid token to work.
        """
    ...
    async def create_guild(
        ...
        *,
        ...
        region : str
            ...
            `RESTSession.list_voice_regions` to see which region IDs are available.
        icon : bytes
