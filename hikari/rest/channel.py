...
class RESTChannelComponent(base.BaseRESTComponent, abc.ABC):  # pylint: disable=abstract-method, too-many-public-methods
    """The RESTSession client component for handling requests to channel endpoints."""
    ...
    async def update_channel(
        ...
        *,
        ...
        parent_category: typing.Optional[typing.Union[bases.Snowflake, int, str, channels_.GuildCategory]] = ...,
        reason: str = ...,
    ) -> channels_.PartialChannel:
    ...
    def fetch_messages(
        ...
        **kwargs: typing.Union[datetime.datetime, int, str, bases.Unique, bases.Snowflake],
        ...
        !!! note
            ...
            same effect as passing `before=hikari.models.bases.Snowflake.max()`. This
        ...
        !!! note
            ...
            documented at a RESTSession API level by Discord.

        Returns
        -------
        hikari.models.pagination.PaginatedResults[hikari.models.messages.Message]
    ...
    async def update_channel_overwrite(  # pylint: disable=line-too-long
        ...
        *,
        ...
        deny: typing.Union[permissions_.Permission, int] = ...,
        reason: str = ...,
    ) -> None:
    ...
    async def trigger_typing(self, channel: typing.Union[bases.Snowflake, int, str, channels_.PartialChannel]) -> None:
    ...
    async def fetch_pins(
        self, channel: typing.Union[bases.Snowflake, int, str, channels_.PartialChannel]
    ) -> typing.Mapping[bases.Snowflake, messages_.Message]:
        ...
        Returns
        -------
        typing.Mapping[hikari.models.bases.Snowflake, hikari.models.messages.Message]
    ...
    async def create_webhook(
        ...
        *,
        ...
        avatar : hikari.models.files.BaseStream
