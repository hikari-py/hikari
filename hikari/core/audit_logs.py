...
from hikari.core import users as _users
from hikari.core import webhooks as _webhooks
...
class ChannelOverwriteEntryInfo(BaseAuditLogEntryInfo):
    ...
    #:
    #: :type: :obj:`hikari.core.channels.PermissionOverwriteType`
...
class AuditLog(entities.HikariEntity, entities.Deserializable):
    ...
    #:
    #: :type: :obj:`typing.Mapping` [ :obj:`hikari.core.snowflakes.Snowflake`, :obj:`AuditLogEntry` ]
    ...
    #:
    #: :type: :obj:`typing.Mapping` [ :obj:`hikari.core.snowflakes.Snowflake`, :obj:`hikari.core.guilds.GuildIntegration` ]
    ...
    #:
    #: :type: :obj:`typing.Mapping` [ :obj:`hikari.core.snowflakes.Snowflake`, :obj:`hikari.core.webhooks.Webhook` ]
