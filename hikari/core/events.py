...
class ReadyEvent(HikariEvent, entities.Deserializable):
    ...
    #:
    #: :type: :obj:`hikari.core.users.MyUser`
    ...
    #: off "unavailable".
    #:
    #: :type: :obj:`typing.Mapping` [ :obj:`hikari.core.snowflake.Snowflake`, :obj:`hikari.core.guilds.UnavailableGuild` ]
...
class BaseChannelEvent(HikariEvent, snowflakes.UniqueEntity, entities.Deserializable):
    ...
    #: The channel's type.
    #:
    #: :type: :obj:`hikari.core.channels.ChannelType`
    ...
    #:
    #: :type: :obj:`typing.Mapping` [ :obj:`hikari.core.snowflakes.Snowflake`, :obj:`hikari.core.channels.PermissionOverwrite` ], optional
    ...
    #:
    #: :type: :obj:`typing.Mapping` [ :obj:`hikari.core.snowflakes.Snowflake`, :obj:`hikari.core.users.User` ], optional
...
class ChannelPinUpdateEvent(HikariEvent, entities.Deserializable):
    ...
    #:
    #: :type: :obj:`hikari.core.snowflake.Snowflake`, optional
    guild_id: typing.Optional[snowflakes.Snowflake] = marshaller.attrib(
        deserializer=snowflakes.Snowflake.deserialize, if_undefined=None
    )
...
class GuildMemberUpdateEvent(HikariEvent, entities.Deserializable):
    ...
    #: and when set to :obj:`hikari.core.entities.UNSET` this hasn't been acted on.
    #:
    ...
    #:
    #: :type: :obj:`typing.Union` [ :obj:`datetime.datetime`, :obj:`hikari.core.entities.UNSET` ], optional
...
class GuildRoleCreateEvent(HikariEvent, entities.Deserializable):
    ...
    #:
    #: :type: :obj:`hikari.core.guilds.GuildRole`
...
class InviteCreateEvent(HikariEvent, entities.Deserializable):
    ...
    #:
    #: :type: :obj:`hikari.core.invites.TargetUserType`, optional
...
class MessageUpdateEvent(HikariEvent, snowflakes.UniqueEntity, entities.Deserializable):
    ...
    set to :obj:`hikari.core.entities.UNSET` if we have not received information
    ...
    #:
    #: :type: :obj:`typing.Union` [ :obj:`hikari.core.snowflakes.Snowflake`, :obj:`hikari.core.entities.UNSET` ]
    ...
    #:
    #: :type: :obj:`typing.Union` [ :obj:`hikari.core.users.User`, :obj:`hikari.core.entities.UNSET` ]
    ...
    #:
    #: :type: :obj:`typing.Union` [ :obj:`hikari.core.guilds.GuildMember`, :obj:`hikari.core.entities.UNSET` ]
    ...
    #:
    #: :type: :obj:`typing.Union` [ :obj:`datetime.datetime`, :obj:`hikari.core.entities.UNSET` ]
    ...
    #:
    #: :type: :obj:`typing.Union` [ :obj:`typing.Set` [ :obj:`hikari.core.snowflakes.Snowflake` ], :obj:`hikari.core.entities.UNSET` ]
    ...
    #:
    #: :type: :obj:`typing.Union` [ :obj:`typing.Sequence` [ :obj:`hikari.core.messages.Attachment` ], :obj:`hikari.core.entities.UNSET` ]
    ...
    #:
    #: :type: :obj:`typing.Union` [ :obj:`typing.Sequence` [ :obj:`hikari.core.embeds.Embed` ], :obj:`hikari.core.entities.UNSET` ]
    ...
    #:
    #: :type: :obj:`typing.Union` [ :obj:`typing.Sequence` [ :obj:`hikari.core.messages.Reaction` ], :obj:`hikari.core.entities.UNSET` ]
    ...
    #: The message's type.
    #:
    #: :type: :obj:`typing.Union` [ :obj:`hikari.core.messages.MessageType`, :obj:`hikari.core.entities.UNSET` ]
    ...
    #:
    #: :type: :obj:`typing.Union` [ :obj:`hikari.core.messages.MessageActivity`, :obj:`hikari.core.entities.UNSET` ]
    ...
    #:
    #: :type: :obj:`typing.Union` [ :obj:`hikari.core.oauth2.Application`, :obj:`hikari.core.entities.UNSET` ]
    ...
    #:
    #: :type: :obj:`typing.Union` [ :obj:`hikari.core.messages.MessageCrosspost`, :obj:`hikari.core.entities.UNSET` ]
    ...
    #: The message's flags.
    #:
    #: :type: :obj:`typing.Union` [ :obj:`hikari.core.messages.MessageFlag`, :obj:`hikari.core.entities.UNSET` ]
...
class MessageReactionAddEvent(HikariEvent, entities.Deserializable):
    ...
    #:
    #: :type: :obj:`typing.Union` [ :obj:`hikari.core.emojis.UnknownEmoji`, :obj:`hikari.core.emojis.UnicodeEmoji` ]
...
class MessageReactionRemoveEmojiEvent(HikariEvent, entities.Deserializable):
    ...
    #:
    #: :type: :obj:`typing.Union` [ :obj:`hikari.core.emojis.UnknownEmoji`, :obj:`emojis.UnicodeEmoji` ]
    emoji: typing.Union[_emojis.UnicodeEmoji, _emojis.UnknownEmoji] = marshaller.attrib(
        deserializer=_emojis.deserialize_reaction_emoji,
    )
