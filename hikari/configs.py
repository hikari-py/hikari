...
class AIOHTTPConfig(BaseConfig):
    """Config for application that use AIOHTTP somewhere.
...
def _deserialize_intents(value) -> intents_.Intent:
    return conversions.dereference_int_flag(intents_.Intent, value)
...
class GatewayConfig(AIOHTTPConfig, DebugConfig, TokenConfig):
    ...
    initial_activity: typing.Optional[gateway_models.Activity] = marshaller.attrib(
        deserializer=gateway_models.Activity.deserialize, if_none=None, if_undefined=None, default=None
    )
    ...
    intents: typing.Optional[intents_.Intent] = marshaller.attrib(
