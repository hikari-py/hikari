...
class UpdatedMessageFields(snowflake.Unique):
    ...
    guild_id: undefined.UndefinedOr[snowflake.Snowflake] = attr.ib(repr=True)
    """The ID of the guild that the message was sent in."""

    author: undefined.UndefinedOr[users.UserImpl] = attr.ib(repr=True)
    """The author of this message."""

    member: undefined.UndefinedOr[guilds.Member] = attr.ib(repr=False)
    """The member properties for the message's author."""

    content: undefined.UndefinedOr[str] = attr.ib(repr=False)
    """The content of the message."""

    timestamp: undefined.UndefinedOr[datetime.datetime] = attr.ib(repr=False)
    """The timestamp that the message was sent at."""

    edited_timestamp: undefined.UndefinedNoneOr[users.UserImpl] = attr.ib(repr=False)
    ...
    attachments: undefined.UndefinedOr[typing.Sequence[messages.Attachment]] = attr.ib(repr=False)
    """The message attachments."""

    embeds: undefined.UndefinedOr[typing.Sequence[embed_models.Embed]] = attr.ib(repr=False)
    """The message's embeds."""

    reactions: undefined.UndefinedOr[typing.Sequence[messages.Reaction]] = attr.ib(repr=False)
    """The message's reactions."""

    is_pinned: undefined.UndefinedOr[bool] = attr.ib(repr=False)
    """Whether the message is pinned."""

    webhook_id: undefined.UndefinedOr[snowflake.Snowflake] = attr.ib(repr=False)
    """If the message was generated by a webhook, the webhook's ID."""

    type: undefined.UndefinedOr[messages.MessageType] = attr.ib(repr=False)
    """The message's type."""

    activity: undefined.UndefinedOr[messages.MessageActivity] = attr.ib(repr=False)
    """The message's activity."""

    application: undefined.UndefinedOr[applications.Application] = attr.ib(repr=False)
    """The message's application."""

    message_reference: undefined.UndefinedOr[messages.MessageCrosspost] = attr.ib(repr=False)
    """The message's cross-posted reference data."""

    flags: undefined.UndefinedOr[messages.MessageFlag] = attr.ib(repr=False)
    """The message's flags."""

    nonce: undefined.UndefinedOr[str] = attr.ib(repr=False)
    """The message nonce.
