...
class MessageUpdateEvent(base_events.HikariEvent, base_models.Unique):
    ...
    guild_id: typing.Union[base_models.Snowflake, undefined.Undefined] = attr.ib(repr=True)
    ...
    member: typing.Union[guilds.GuildMember, undefined.Undefined] = attr.ib()
    ...
    user_mentions: typing.Union[typing.Set[base_models.Snowflake], undefined.Undefined] = attr.ib()
    """The users the message mentions."""

    role_mentions: typing.Union[typing.Set[base_models.Snowflake], undefined.Undefined] = attr.ib()
    """The roles the message mentions."""

    channel_mentions: typing.Union[typing.Set[base_models.Snowflake], undefined.Undefined] = attr.ib()
    ...
    webhook_id: typing.Union[base_models.Snowflake, undefined.Undefined] = attr.ib()
