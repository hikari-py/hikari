...
class MessageUpdateEvent(base_events.HikariEvent, base_models.Unique, marshaller.Deserializable):
    ...
    guild_id: typing.Union[base_models.Snowflake, unset.Unset] = attr.ib(
        deserializer=base_models.Snowflake, if_undefined=unset.Unset, default=unset.UNSET, repr=True
    )
    """The ID of the guild that the message was sent in."""

    author: typing.Union[users.User, unset.Unset] = attr.ib(
    ...
    member: typing.Union[guilds.GuildMember, unset.Unset] = attr.ib(
    ...
    content: typing.Union[str, unset.Unset] = attr.ib(deserializer=str, if_undefined=unset.Unset, default=unset.UNSET)
    """The content of the message."""

    timestamp: typing.Union[datetime.datetime, unset.Unset] = attr.ib(
        deserializer=conversions.iso8601_datetime_string_to_datetime, if_undefined=unset.Unset, default=unset.UNSET
    )
    """The timestamp that the message was sent at."""

    edited_timestamp: typing.Union[datetime.datetime, unset.Unset, None] = attr.ib(
    ...
    is_tts: typing.Union[bool, unset.Unset] = attr.ib(
        raw_name="tts", deserializer=bool, if_undefined=unset.Unset, default=unset.UNSET
    )
    """Whether the message is a TTS message."""

    is_mentioning_everyone: typing.Union[bool, unset.Unset] = attr.ib(
    ...
    user_mentions: typing.Union[typing.Set[base_models.Snowflake], unset.Unset] = attr.ib(
    ...
    role_mentions: typing.Union[typing.Set[base_models.Snowflake], unset.Unset] = attr.ib(
    ...
    channel_mentions: typing.Union[typing.Set[base_models.Snowflake], unset.Unset] = attr.ib(
    ...
    attachments: typing.Union[typing.Sequence[messages.Attachment], unset.Unset] = attr.ib(
        deserializer=_deserialize_attachments, if_undefined=unset.Unset, default=unset.UNSET, inherit_kwargs=True,
    )
    """The message attachments."""

    embeds: typing.Union[typing.Sequence[embed_models.Embed], unset.Unset] = attr.ib(
        deserializer=_deserialize_embeds, if_undefined=unset.Unset, default=unset.UNSET, inherit_kwargs=True,
    )
    """The message's embeds."""

    reactions: typing.Union[typing.Sequence[messages.Reaction], unset.Unset] = attr.ib(
    ...
    is_pinned: typing.Union[bool, unset.Unset] = attr.ib(
        raw_name="pinned", deserializer=bool, if_undefined=unset.Unset, default=unset.UNSET
    )
    """Whether the message is pinned."""

    webhook_id: typing.Union[base_models.Snowflake, unset.Unset] = attr.ib(
    ...
    type: typing.Union[messages.MessageType, unset.Unset] = attr.ib(
        deserializer=messages.MessageType, if_undefined=unset.Unset, default=unset.UNSET
    )
    """The message's type."""

    activity: typing.Union[messages.MessageActivity, unset.Unset] = attr.ib(
    ...
    message_reference: typing.Union[messages.MessageCrosspost, unset.Unset] = attr.ib(
    ...
    flags: typing.Union[messages.MessageFlag, unset.Unset] = attr.ib(
        deserializer=messages.MessageFlag, if_undefined=unset.Unset, default=unset.UNSET
    )
    """The message's flags."""

    nonce: typing.Union[str, unset.Unset] = attr.ib(deserializer=str, if_undefined=unset.Unset, default=unset.UNSET)
    """The message nonce.
...
class MessageDeleteEvent(base_events.HikariEvent, marshaller.Deserializable):
    ...
    message_id: base_models.Snowflake = attr.ib(raw_name="id", deserializer=base_models.Snowflake, repr=True)
...
class MessageDeleteBulkEvent(base_events.HikariEvent, marshaller.Deserializable):
    ...
    message_ids: typing.Set[base_models.Snowflake] = attr.ib(raw_name="ids", deserializer=_deserialize_message_ids)
...
class MessageReactionAddEvent(base_events.HikariEvent, marshaller.Deserializable):
    ...
    message_id: base_models.Snowflake = attr.ib(deserializer=base_models.Snowflake, repr=True)
    ...
    emoji: typing.Union[emojis.CustomEmoji, emojis.UnicodeEmoji] = attr.ib(
...
class MessageReactionRemoveEvent(base_events.HikariEvent, marshaller.Deserializable):
    ...
    emoji: typing.Union[emojis.UnicodeEmoji, emojis.CustomEmoji] = attr.ib(
        deserializer=emojis.deserialize_reaction_emoji, inherit_kwargs=True, repr=True
    )
