...
class MessageCreateEvent(bases.HikariEvent, messages.Message):
...
@marshaller.marshallable()
@attr.s(slots=True, kw_only=True)
class MessageUpdateEvent(bases.HikariEvent, _bases.UniqueEntity, marshaller.Deserializable):
    ...
    channel_id: _bases.Snowflake = marshaller.attrib(deserializer=_bases.Snowflake.deserialize)
    """The ID of the channel that the message was sent in."""

    guild_id: typing.Union[_bases.Snowflake, unset.Unset] = marshaller.attrib(
        deserializer=_bases.Snowflake.deserialize, if_undefined=unset.Unset, default=unset.UNSET
    )
    ...
    user_mentions: typing.Union[typing.Set[_bases.Snowflake], unset.Unset] = marshaller.attrib(
        raw_name="mentions",
        deserializer=lambda user_mentions: {_bases.Snowflake.deserialize(u["id"]) for u in user_mentions},
        if_undefined=unset.Unset,
        default=unset.UNSET,
    )
    """The users the message mentions."""

    role_mentions: typing.Union[typing.Set[_bases.Snowflake], unset.Unset] = marshaller.attrib(
        raw_name="mention_roles",
        deserializer=lambda role_mentions: {_bases.Snowflake.deserialize(r) for r in role_mentions},
        if_undefined=unset.Unset,
        default=unset.UNSET,
    )
    """The roles the message mentions."""

    channel_mentions: typing.Union[typing.Set[_bases.Snowflake], unset.Unset] = marshaller.attrib(
        raw_name="mention_channels",
        deserializer=lambda channel_mentions: {_bases.Snowflake.deserialize(c["id"]) for c in channel_mentions},
        if_undefined=unset.Unset,
        default=unset.UNSET,
    )
    ...
    webhook_id: typing.Union[_bases.Snowflake, unset.Unset] = marshaller.attrib(
        deserializer=_bases.Snowflake.deserialize, if_undefined=unset.Unset, default=unset.UNSET
    )
...
@marshaller.marshallable()
@attr.s(slots=True, kw_only=True)
class MessageDeleteEvent(bases.HikariEvent, marshaller.Deserializable):
    ...
    guild_id: typing.Optional[_bases.Snowflake] = marshaller.attrib(
        deserializer=_bases.Snowflake.deserialize, if_undefined=None, default=None
    )
    ...
    message_id: _bases.Snowflake = marshaller.attrib(raw_name="id", deserializer=_bases.Snowflake.deserialize)
    """The ID of the message that was deleted."""


@bases.requires_intents(intents.Intent.GUILD_MESSAGES)
@marshaller.marshallable()
@attr.s(slots=True, kw_only=True)
class MessageDeleteBulkEvent(bases.HikariEvent, marshaller.Deserializable):
    ...
    guild_id: typing.Optional[_bases.Snowflake] = marshaller.attrib(
        deserializer=_bases.Snowflake.deserialize, if_none=None
    )
    """The ID of the channel these messages have been deleted in.
    ...
    message_ids: typing.Set[_bases.Snowflake] = marshaller.attrib(
        raw_name="ids", deserializer=lambda msgs: {_bases.Snowflake.deserialize(m) for m in msgs}
    )
    """A collection of the IDs of the messages that were deleted."""


@bases.requires_intents(intents.Intent.GUILD_MESSAGE_REACTIONS, intents.Intent.DIRECT_MESSAGE_REACTIONS)
@marshaller.marshallable()
@attr.s(slots=True, kw_only=True)
class MessageReactionAddEvent(bases.HikariEvent, marshaller.Deserializable):
    """Used to represent Message Reaction Add gateway events."""

    user_id: _bases.Snowflake = marshaller.attrib(deserializer=_bases.Snowflake.deserialize)
    """The ID of the user adding the reaction."""

    channel_id: _bases.Snowflake = marshaller.attrib(deserializer=_bases.Snowflake.deserialize)
    """The ID of the channel where this reaction is being added."""

    message_id: _bases.Snowflake = marshaller.attrib(deserializer=_bases.Snowflake.deserialize)
...
@marshaller.marshallable()
@attr.s(slots=True, kw_only=True)
class MessageReactionRemoveEvent(bases.HikariEvent, marshaller.Deserializable):
...
@marshaller.marshallable()
@attr.s(slots=True, kw_only=True)
class MessageReactionRemoveAllEvent(bases.HikariEvent, marshaller.Deserializable):
...
@marshaller.marshallable()
@attr.s(slots=True, kw_only=True)
class MessageReactionRemoveEmojiEvent(bases.HikariEvent, marshaller.Deserializable):
