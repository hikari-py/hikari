...
class StatelessEventManagerImpl(event_managers.EventManager[dispatchers.EventDispatcher]):
    ...
    async def on_connect(self, shard, _) -> None:
        ...
        await self._app.event_dispatcher.dispatch_event(event)
    ...
    async def on_ready(self, _, payload) -> None:
        """Handle READY events."""
        event = other.ReadyEvent.deserialize(payload, app=self._app)
        await self._app.event_dispatcher.dispatch_event(event)
    ...
    async def on_channel_create(self, _, payload) -> None:
        ...
        event = channel.ChannelCreateEvent.deserialize(payload, app=self._app)
        await self._app.event_dispatcher.dispatch_event(event)
    ...
    async def on_channel_update(self, _, payload) -> None:
        ...
        event = channel.ChannelUpdateEvent.deserialize(payload, app=self._app)
        await self._app.event_dispatcher.dispatch_event(event)
    ...
    async def on_channel_delete(self, _, payload) -> None:
        ...
        event = channel.ChannelDeleteEvent.deserialize(payload, app=self._app)
        await self._app.event_dispatcher.dispatch_event(event)
    ...
    async def on_guild_delete(self, _, payload) -> None:
        ...
        if payload.get("unavailable", False):
            event = guild.GuildUnavailableEvent.deserialize(payload, app=self._app)
        else:
            event = guild.GuildLeaveEvent.deserialize(payload, app=self._app)
        await self._app.event_dispatcher.dispatch_event(event)

    @event_managers.raw_event_mapper("GUILD_BAN_ADD")
    async def on_guild_ban_add(self, _, payload) -> None:
        """Handle GUILD_BAN_ADD events."""
        event = guild.GuildBanAddEvent.deserialize(payload, app=self._app)
        await self._app.event_dispatcher.dispatch_event(event)
    ...
    async def on_guild_ban_remove(self, _, payload) -> None:
        ...
        event = guild.GuildBanRemoveEvent.deserialize(payload, app=self._app)
        await self._app.event_dispatcher.dispatch_event(event)
    ...
    async def on_guild_emojis_update(self, _, payload) -> None:
        ...
        event = guild.GuildEmojisUpdateEvent.deserialize(payload, app=self._app)
        await self._app.event_dispatcher.dispatch_event(event)
    ...
    async def on_guild_integrations_update(self, _, payload) -> None:
        ...
        event = guild.GuildIntegrationsUpdateEvent.deserialize(payload, app=self._app)
        await self._app.event_dispatcher.dispatch_event(event)
    ...
    async def on_guild_member_add(self, _, payload) -> None:
        ...
        event = guild.GuildMemberAddEvent.deserialize(payload, app=self._app)
        await self._app.event_dispatcher.dispatch_event(event)
    ...
    async def on_guild_member_update(self, _, payload) -> None:
        ...
        event = guild.GuildMemberUpdateEvent.deserialize(payload, app=self._app)
        await self._app.event_dispatcher.dispatch_event(event)
    ...
    async def on_guild_member_remove(self, _, payload) -> None:
        ...
        event = guild.GuildMemberRemoveEvent.deserialize(payload, app=self._app)
        await self._app.event_dispatcher.dispatch_event(event)
    ...
    async def on_guild_role_create(self, _, payload) -> None:
        ...
        event = guild.GuildRoleCreateEvent.deserialize(payload, app=self._app)
        await self._app.event_dispatcher.dispatch_event(event)
    ...
    async def on_guild_role_update(self, _, payload) -> None:
        ...
        event = guild.GuildRoleUpdateEvent.deserialize(payload, app=self._app)
        await self._app.event_dispatcher.dispatch_event(event)
    ...
    async def on_message_create(self, _, payload) -> None:
        ...
        event = message.MessageCreateEvent.deserialize(payload, app=self._app)
        await self._app.event_dispatcher.dispatch_event(event)
    ...
    async def on_message_update(self, _, payload) -> None:
        ...
        if "member" in payload and "author" in payload:
            payload["member"]["user"] = payload["author"]
        event = message.MessageUpdateEvent.deserialize(payload, app=self._app)
        await self._app.event_dispatcher.dispatch_event(event)
    ...
    async def on_message_delete(self, _, payload) -> None:
        ...
        event = message.MessageDeleteEvent.deserialize(payload, app=self._app)
        await self._app.event_dispatcher.dispatch_event(event)
    ...
    async def on_message_delete_bulk(self, _, payload) -> None:
        ...
        event = message.MessageDeleteBulkEvent.deserialize(payload, app=self._app)
        await self._app.event_dispatcher.dispatch_event(event)
    ...
    async def on_message_reaction_add(self, _, payload) -> None:
        ...
        event = message.MessageReactionAddEvent.deserialize(payload, app=self._app)
        await self._app.event_dispatcher.dispatch_event(event)
    ...
    async def on_message_reaction_remove(self, _, payload) -> None:
        ...
        event = message.MessageReactionRemoveEvent.deserialize(payload, app=self._app)
        await self._app.event_dispatcher.dispatch_event(event)
    ...
    async def on_message_reaction_remove_emoji(self, _, payload) -> None:
        ...
        event = message.MessageReactionRemoveEmojiEvent.deserialize(payload, app=self._app)
        await self._app.event_dispatcher.dispatch_event(event)
    ...
    async def on_voice_state_update(self, _, payload) -> None:
        ...
        event = voice.VoiceStateUpdateEvent.deserialize(payload, app=self._app)
        await self._app.event_dispatcher.dispatch_event(event)
    ...
    async def on_voice_server_update(self, _, payload) -> None:
        ...
        event = voice.VoiceServerUpdateEvent.deserialize(payload, app=self._app)
        await self._app.event_dispatcher.dispatch_event(event)
    ...
    async def on_webhook_update(self, _, payload) -> None:
        ...
        event = channel.WebhookUpdateEvent.deserialize(payload, app=self._app)
        await self._app.event_dispatcher.dispatch_event(event)
