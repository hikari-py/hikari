    ...
    **kwargs
    ...
    async def start(self) -> None:
        ...
        if self.event_manager is not None:
            await self.dispatch_event(other_events.StartedEvent())
    ...
    async def _calculate_shards(self):
        ...
        shard_clients: typing.Dict[int, gateway_client.GatewayClient] = {}
    ...
    async def close(self) -> None:
        try:
            if self.shards and not self._is_shutting_down:
                ...
                start_time = time.perf_counter()
                try:
                    await self.dispatch_event(other_events.StoppingEvent())
                    ...
                    await self.dispatch_event(other_events.StoppedEvent())
        finally:
    ...
    async def update_presence(
        ...
        *,
        ...
        activity: typing.Optional[gateway_models.Activity] = ...,
