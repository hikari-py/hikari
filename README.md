...
[customising timeouts for requests](https://www.hikari-py.dev/hikari/impl/config.html#hikari.impl.config.HTTPSettings.timeouts)
and [enabling a proxy](https://www.hikari-py.dev/hikari/impl/config.html#hikari.impl.config.ProxySettings).
