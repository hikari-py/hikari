...
class TestSessionStartLimit:
    def test_deserialize(self, test_session_start_limit_payload, mock_app):
        session_start_limit_obj = gateway.SessionStartLimit.deserialize(test_session_start_limit_payload, app=mock_app)
...
class TestGatewayBot:
    ...
    def test_deserialize(self, test_gateway_bot_payload, test_session_start_limit_payload, mock_app):
        ...
        with _helpers.patch_marshal_attr(
            ...
            gateway_bot_obj = gateway.GatewayBot.deserialize(test_gateway_bot_payload, app=mock_app)
            patched_start_limit_deserializer.assert_called_once_with(test_session_start_limit_payload, app=mock_app)
