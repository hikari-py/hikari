...
class TestVoiceState:
    def test_deserialize(self, voice_state_payload, mock_app):
        voice_state_obj = voices.VoiceState.deserialize(voice_state_payload, app=mock_app)
...
class TestVoiceRegion:
    def test_deserialize(self, voice_region_payload, mock_app):
        voice_region_obj = voices.VoiceRegion.deserialize(voice_region_payload, app=mock_app)
