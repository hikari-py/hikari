...
import hikari.state.models.members
...
class TestOverwriteEntityType:
    def test_OverwriteEntityType_instancecheck(self):
        m = mock.MagicMock(spec=hikari.state.models.members.Member)
        ...
        assert isinstance(m, hikari.state.models.members.Member)
        assert type(m) is not hikari.state.models.members.Member
    ...
    def test_OverwriteEntityType_subclasscheck(self):
        assert issubclass(
            hikari.state.models.members.Member, overwrites.OverwriteEntityType.MEMBER.value
        )  # always should be right
        assert issubclass(
            hikari.state.models.members.Member, overwrites.OverwriteEntityType.MEMBER
