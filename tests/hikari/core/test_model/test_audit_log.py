...
from hikari.core.model import audit_log

from tests.hikari.core.testdata import *


@pytest.fixture
@fixture_test_data(json("audit_log"))
...
@pytest.fixture
@fixture_test_data(json("audit_log_entry_edit_channel"))
...
@pytest.fixture
@fixture_test_data(json("audit_log_entry_invite_create"))
...
@pytest.fixture
@fixture_test_data(json("audit_log_entry_message_delete"))
...
@pytest.fixture
@fixture_test_data(json("audit_log_entry_overwrites_add"))
...
@pytest.fixture
@fixture_test_data(json("audit_log_entry_overwrites_delete"))
...
@pytest.fixture
@fixture_test_data(json("audit_log_entry_overwrites_update"))
...
@pytest.fixture
@fixture_test_data(json("audit_log_entry_role_add"))
...
@pytest.fixture
@fixture_test_data(json("audit_log_entry_role_remove"))
