...
from hikari.models import unset, permissions, guilds, users, colors, channels, emojis
...
class TestPresenceActivity:
    def test_deserialize(
        ...
        assert presence_activity_obj.timestamps._app is mock_components
...
class TestGuildMemberPresence:
    def test_deserialize(
        ...
        assert guild_member_presence_obj.user._app is mock_components
        ...
        assert guild_member_presence_obj.activities[0]._app is mock_components
        assert guild_member_presence_obj.client_status == guilds.ClientStatus.deserialize(test_client_status_payload)
        assert guild_member_presence_obj.client_status._app is mock_components
...
class TestPartialGuildIntegration:
    def test_deserialise(
        ...
        assert partial_guild_integration_obj.account._app is mock_components
...
class TestGuild:
    def test_deserialize(
        ...
        with stack:
            ...
            assert guild_obj.members[123456]._app is mock_components
        assert guild_obj.presences == {123456: guilds.GuildMemberPresence.deserialize(test_guild_member_presence)}
        assert guild_obj.presences[123456]._app is mock_components
        ...
        assert guild_obj.roles[41771983423143936]._app is mock_components
