...
class TestEntityFactoryImpl:
    ...
    def test_deserialize_own_guild(self, entity_factory_impl, mock_app, own_guild_payload):
        ...
        assert own_guild.features == {guilds.GuildFeature.DISCOVERABLE, "FORCE_RELAY"}
        assert own_guild.is_owner is False
        assert own_guild.my_permissions == permissions.Permission(2147483647)
    ...
    def user_payload(self):
        return {"username": "agent 47", "avatar": "hashed", "discriminator": "4747", "id": "474747474"}
    ...
    def test_deserialize_application(
        ...
        assert isinstance(application.team, applications.Team)
        # TeamMember
        assert len(application.team.members) == 1
        member = application.team.members[115590097100865541]
        assert member.membership_state == applications.TeamMembershipState.INVITED
        ...
        assert isinstance(member, applications.TeamMember)
        ...
        assert isinstance(application, applications.Application)
    ...
    def test__deserialize_audit_log_change_roles(self, entity_factory_impl):
        ...
        assert isinstance(role, guilds.PartialRole)
    ...
    def test__deserialize_channel_overwrite_entry_info(self, entity_factory_impl, overwrite_info_payload):
        ...
        assert isinstance(overwrite_entry_info, audit_logs.ChannelOverwriteEntryInfo)
    ...
    def test__deserialize_message_pin_entry_info(self, entity_factory_impl, message_pin_info_payload):
        ...
        assert isinstance(message_pin_info, audit_logs.MessagePinEntryInfo)
    ...
    def test__deserialize_member_prune_entry_info(self, entity_factory_impl, member_prune_info_payload):
        ...
        assert isinstance(member_prune_info, audit_logs.MemberPruneEntryInfo)
    ...
    def test__deserialize_message_bulk_delete_entry_info(self, entity_factory_impl, message_bulk_delete_info_payload):
        ...
        assert isinstance(message_bulk_delete_entry_info, audit_logs.MessageBulkDeleteEntryInfo)
    ...
    def test__deserialize_message_delete_entry_info(self, entity_factory_impl, message_delete_info_payload):
        ...
        assert isinstance(message_delete_entry_info, audit_logs.MessageDeleteEntryInfo)
    ...
    def test__deserialize_member_disconnect_entry_info(self, entity_factory_impl, member_disconnect_info_payload):
        ...
        assert isinstance(member_disconnect_entry_info, audit_logs.MemberDisconnectEntryInfo)
    ...
    def test__deserialize_member_move_entry_info(self, entity_factory_impl, member_move_info_payload):
        ...
        assert isinstance(member_move_entry_info, audit_logs.MemberMoveEntryInfo)
    ...
    def test__deserialize_unrecognised_audit_log_entry_info(self, entity_factory_impl, unrecognised_audit_log_entry):
        ...
        assert isinstance(unrecognised_info, audit_logs.UnrecognisedAuditLogEntryInfo)
    ...
    def test_deserialize_permission_overwrite(self, entity_factory_impl, permission_overwrite_payload):
        ...
        assert overwrite.type == channels.PermissionOverwriteType.MEMBER
        assert overwrite.allow == permissions.Permission(65)
        assert overwrite.deny == permissions.Permission(49152)
        assert isinstance(overwrite, channels.PermissionOverwrite)

    def test_serialize_permission_overwrite(self, entity_factory_impl):
        overwrite = channels.PermissionOverwrite(id=123123, type="member", allow=42, deny=62)
    ...
    def test_deserialize_partial_channel(self, entity_factory_impl, mock_app, partial_channel_payload):
        ...
        assert partial_channel.type == channels.ChannelType.GUILD_TEXT
    ...
    def test_deserialize_dm_channel(self, entity_factory_impl, mock_app, dm_channel_payload, user_payload):
        ...
        assert isinstance(dm_channel, channels.DMChannel)
    ...
    def test_test_deserialize_group_dm_channel_with_unset_fields(self, entity_factory_impl, user_payload):
        ...
        assert dm_channel.application_id is None
    ...
    def test_deserialize_guild_category(
        ...
        assert guild_category.type == channels.ChannelType.GUILD_CATEGORY
        ...
        assert isinstance(guild_category, channels.GuildCategory)
    ...
    def test_deserialize_guild_text_channel(
        ...
        assert guild_text_channel.type == channels.ChannelType.GUILD_TEXT
        ...
        assert isinstance(guild_text_channel, channels.GuildTextChannel)
    ...
    def test_deserialize_guild_news_channel(
        ...
        assert news_channel.id == 567
        assert news_channel.name == "Important Announcements"
        assert news_channel.type == channels.ChannelType.GUILD_NEWS
        ...
        assert isinstance(news_channel, channels.GuildNewsChannel)
    ...
    def test_deserialize_guild_store_channel(
        ...
        assert store_chanel.type == channels.ChannelType.GUILD_STORE
        ...
        assert isinstance(store_chanel, channels.GuildStoreChannel)
    ...
    def test_deserialize_guild_voice_channel(
        ...
        assert voice_channel.type == channels.ChannelType.GUILD_VOICE
        ...
        assert isinstance(voice_channel, channels.GuildVoiceChannel)
    ...
    def test_deserialize_channel_returns_right_type(
        ...
        for payload, expected_type in [
            (dm_channel_payload, channels.DMChannel),
            (group_dm_channel_payload, channels.GroupDMChannel),
            (guild_category_payload, channels.GuildCategory),
            (guild_text_channel_payload, channels.GuildTextChannel),
            (guild_news_channel_payload, channels.GuildNewsChannel),
            (guild_store_channel_payload, channels.GuildStoreChannel),
            (guild_voice_channel_payload, channels.GuildVoiceChannel),
        ]:
    ...
    def test_deserialize_embed_with_full_embed(self, entity_factory_impl, embed_payload):
        ...
        assert embed.color == colors.Color(14014915)
        assert isinstance(embed.color, colors.Color)
        # EmbedFooter
        ...
        assert isinstance(embed.footer, embeds.EmbedFooter)
        # EmbedImage
        ...
        assert isinstance(embed.image, embeds.EmbedImage)
        # EmbedThumbnail
        ...
        assert isinstance(embed.author, embeds.EmbedAuthor)
        # EmbedField
        ...
        assert isinstance(field, embeds.EmbedField)
    ...
    def test_serialize_embed(self, entity_factory_impl):
        payload = entity_factory_impl.serialize_embed(
            embeds.Embed(
                ...
                color=colors.Color(321321),
                footer=embeds.EmbedFooter(text="TEXT", icon_url="httppppp"),
                image=embeds.EmbedImage(url="https://///"),
                thumbnail=embeds.EmbedThumbnail(url="wss://not-a-valid-url"),
                author=embeds.EmbedAuthor(name="AUTH ME", url="wss://\\_/-_-\\_/", icon_url="icon://"),
                fields=[embeds.EmbedField(value="VALUE", name="NAME", is_inline=True)],
            )
        )
        assert payload == {
            "title": "Title",
    ...
    def test_serialize_embed_with_null_attributes(self, entity_factory_impl):
        assert entity_factory_impl.serialize_embed(embeds.Embed()) == {}
    ...
    def test_deserialize_unicode_emoji(self, entity_factory_impl):
        ...
        assert emoji.name == "🤷"
        assert isinstance(emoji, emojis.UnicodeEmoji)
    ...
    def test_deserialize_custom_emoji(self, entity_factory_impl, mock_app, custom_emoji_payload):
        ...
        assert isinstance(emoji, emojis.CustomEmoji)
    ...
    def test_deserialize_known_custom_emoji(
        ...
        assert isinstance(emoji, emojis.KnownCustomEmoji)
    ...
    def test_deserialize_widget_embed(self, entity_factory_impl, mock_app, guild_embed_payload):
        ...
        assert isinstance(guild_embed, guilds.GuildWidget)
    ...
    def test_deserialize_role(self, entity_factory_impl, mock_app, guild_role_payload):
        ...
        assert guild_role.color == colors.Color(3_447_003)
        assert guild_role.is_hoisted is True
        assert guild_role.position == 0
        assert guild_role.permissions == permissions.Permission(66_321_471)
        assert guild_role.is_managed is False
        assert guild_role.is_mentionable is False
        assert isinstance(guild_role, guilds.Role)
    ...
    def test_deserialize_partial_integration(self, entity_factory_impl, partial_integration_payload):
        ...
        assert isinstance(partial_integration, guilds.PartialIntegration)
        # IntegrationAccount
        assert partial_integration.account.id == "543453"
        assert partial_integration.account.name == "Blam"
        assert isinstance(partial_integration.account, guilds.IntegrationAccount)
    ...
    def test_deserialize_integration(self, entity_factory_impl, integration_payload, user_payload):
        ...
        assert isinstance(integration.account, guilds.IntegrationAccount)
        ...
        assert integration.expire_behavior == guilds.IntegrationExpireBehaviour.KICK
        ...
        assert isinstance(integration, guilds.Integration)
    ...
    def test_deserialize_guild_member_ban(self, entity_factory_impl, guild_member_ban_payload, user_payload):
        ...
        assert isinstance(member_ban, guilds.GuildMemberBan)
    ...
    def test_deserialize_unavailable_guild(self, entity_factory_impl, mock_app):
        ...
        assert isinstance(unavailable_guild, guilds.UnavailableGuild)
    ...
    def test_deserialize_guild_preview(
        ...
        assert guild_preview.features == {guilds.GuildFeature.DISCOVERABLE, "FORCE_RELAY"}
        ...
        assert isinstance(guild_preview, guilds.GuildPreview)
    ...
    def guild_payload(
        ...
        return {
            ...
            "banner": "1a2b3c",
            "channels": [guild_text_channel_payload, guild_voice_channel_payload],
    ...
    def test_deserialize_guild(
        ...
        assert guild.features == {
            guilds.GuildFeature.ANIMATED_ICON,
            guilds.GuildFeature.MORE_EMOJI,
            guilds.GuildFeature.NEWS,
        ...
        assert guild.my_permissions == permissions.Permission(66_321_471)
        ...
        assert guild.verification_level == guilds.GuildVerificationLevel.VERY_HIGH
        assert guild.default_message_notifications == guilds.GuildMessageNotificationsLevel.ONLY_MENTIONS
        assert guild.explicit_content_filter == guilds.GuildExplicitContentFilterLevel.ALL_MEMBERS
        ...
        assert guild.mfa_level == guilds.GuildMFALevel.ELEVATED
        ...
        assert guild.system_channel_flags == guilds.GuildSystemChannelFlag(3)
        ...
        assert guild.premium_tier == guilds.GuildPremiumTier.TIER_2
    ...
    def test_deserialize_vanity_url(self, entity_factory_impl, mock_app, vanity_url_payload):
        ...
        assert isinstance(vanity_url, invites.VanityURL)
    ...
    def test_deserialize_invite(
        ...
        assert invite.guild.verification_level == guilds.GuildVerificationLevel.MEDIUM
        ...
        assert invite.target_user_type == invites.TargetUserType.STREAM
        assert invite.approximate_member_count == 84
        assert invite.approximate_presence_count == 42
        assert isinstance(invite, invites.Invite)

    def test_deserialize_invite_with_null_and_unset_fields(self, entity_factory_impl, partial_channel_payload):
        invite = entity_factory_impl.deserialize_invite({"code": "aCode", "channel": partial_channel_payload})
    ...
    def test_deserialize_invite_with_metadata(
        ...
        assert invite_with_metadata.guild.verification_level == guilds.GuildVerificationLevel.MEDIUM
        ...
        assert invite_with_metadata.target_user_type == invites.TargetUserType.STREAM
        ...
        assert isinstance(invite_with_metadata, invites.InviteWithMetadata)
    ...
    def test_deserialize_full_message(
        ...
        assert isinstance(attachment, messages.Attachment)
        ...
        assert isinstance(reaction, messages.Reaction)

        assert message.is_pinned is True
        assert message.webhook_id == 1234
        assert message.type == messages.MessageType.DEFAULT
        # Activity
        assert message.activity.type == messages.MessageActivityType.JOIN_REQUEST
        assert message.activity.party_id == "ae488379-351d-4a4f-ad32-2b9b01c91657"
        assert isinstance(message.activity, messages.MessageActivity)
        ...
        assert message.flags == messages.MessageFlag.IS_CROSSPOST
    ...
    def test_deserialize_user(self, entity_factory_impl, mock_app, user_payload):
        ...
        assert user.flags == users.UserFlag.VERIFIED_BOT_DEVELOPER
    ...
    def test_deserialize_user_with_unset_fields(self, entity_factory_impl, mock_app, user_payload):
        ...
        assert user.flags == users.UserFlag.NONE
    ...
    def test_deserialize_voice_state(self, entity_factory_impl, mock_app, voice_state_payload, guild_member_payload):
        ...
        assert isinstance(voice_state, voices.VoiceState)
    ...
    def test_deserialize_voice_region(self, entity_factory_impl, voice_region_payload):
        ...
        assert isinstance(voice_region, voices.VoiceRegion)
    ...
    def test_deserialize_webhook(self, entity_factory_impl, mock_app, webhook_payload, user_payload):
        ...
        assert webhook.type == webhooks.WebhookType.INCOMING
