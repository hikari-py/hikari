...
def test__deserialize_partial_roles(mock_components):
    test_role_payloads = [
    ...
    with mock.patch.object(guilds.PartialGuildRole, "deserialize", side_effect=mock_role_objs):
        result = audit_logs._deserialize_partial_roles(test_role_payloads, components=mock_components)
        assert result == {24: mock_role_objs[0], 48: mock_role_objs[1]}
        guilds.PartialGuildRole.deserialize.assert_has_calls(
            [
                mock.call(test_role_payloads[0], components=mock_components),
                mock.call(test_role_payloads[1], components=mock_components),
            ]
        )
...
def test__deserialize_overwrites(mock_components):
    ...
    with mock.patch.object(channels.PermissionOverwrite, "deserialize", side_effect=mock_overwrite_objs):
        result = audit_logs._deserialize_overwrites(test_overwrite_payloads, components=mock_components)
        assert result == {24: mock_overwrite_objs[0], 48: mock_overwrite_objs[1]}
        channels.PermissionOverwrite.deserialize.assert_has_calls(
            [
                mock.call(test_overwrite_payloads[0], components=mock_components),
                mock.call(test_overwrite_payloads[1], components=mock_components),
            ]
        )
...
class TestAuditLogChange:
    def test_deserialize_with_known_component_less_converter_and_values(self, mock_components):
        ...
        with mock.patch.object(guilds.PartialGuildRole, "deserialize", side_effect=[mock_role_zero, mock_role_one]):
            audit_log_change_obj = audit_logs.AuditLogChange.deserialize(
                test_audit_log_change_payload, components=mock_components
            )
        assert audit_log_change_obj._components is mock_components
    ...
    def test_deserialize_with_known_component_full_converter_and_values(
        self, test_audit_log_change_payload, mock_components
    ):
        mock_role_zero = mock.MagicMock(guilds.PartialGuildRole, id=123123123312312)
        mock_role_one = mock.MagicMock(guilds.PartialGuildRole, id=568651298858074123)
        with mock.patch.object(guilds.PartialGuildRole, "deserialize", side_effect=[mock_role_zero, mock_role_one]):
            ...
            guilds.PartialGuildRole.deserialize.assert_has_calls(
                [
                    mock.call({"id": "123123123312312", "name": "aRole"}, components=mock_components),
                    mock.call({"id": "568651298858074123", "name": "Casual"}, components=mock_components),
                ]
            )
        assert audit_log_change_obj._components is mock_components
    ...
    def test_deserialize_with_unknown_converter_and_values(self, test_audit_log_change_payload, mock_components):
    ...
    def test_deserialize_with_unknown_converter_and_no_values(self, test_audit_log_change_payload, mock_components):
        test_audit_log_change_payload["key"] = "aUnknownKey"
...
class TestChannelOverwriteEntryInfo:
    ...
    def test_deserialize(self, test_overwrite_info_payload, mock_components):
        overwrite_entry_info = audit_logs.ChannelOverwriteEntryInfo.deserialize(
            test_overwrite_info_payload, components=mock_components
        )
...
class TestMessagePinEntryInfo:
    ...
    def test_deserialize(self, test_message_pin_info_payload, mock_components):
        message_pin_info_obj = audit_logs.MessagePinEntryInfo.deserialize(
            test_message_pin_info_payload, components=mock_components
        )
...
class TestMemberPruneEntryInfo:
    ...
    def test_deserialize(self, test_member_prune_info_payload, mock_components):
        member_prune_info_obj = audit_logs.MemberPruneEntryInfo.deserialize(
            test_member_prune_info_payload, components=mock_components
        )
...
class TestMessageDeleteEntryInfo:
    ...
    def test_deserialize(self, test_message_delete_info_payload, mock_components):
        message_delete_entry_info = audit_logs.MessageDeleteEntryInfo.deserialize(
            test_message_delete_info_payload, components=mock_components
        )
...
class TestMessageBulkDeleteEntryInfo:
    ...
    def test_deserialize(self, test_message_bulk_delete_info_payload, mock_components):
        message_bulk_delete_entry_info = audit_logs.MessageBulkDeleteEntryInfo.deserialize(
            test_message_bulk_delete_info_payload, components=mock_components
        )
...
class TestMemberDisconnectEntryInfo:
    ...
    def test_deserialize(self, test_member_disconnect_info_payload, mock_components):
        member_disconnect_entry_info = audit_logs.MemberDisconnectEntryInfo.deserialize(
            test_member_disconnect_info_payload, components=mock_components
        )
...
class TestMemberMoveEntryInfo:
    ...
    def test_deserialize(self, test_member_move_info_payload, mock_components):
        member_move_entry_info = audit_logs.MemberMoveEntryInfo.deserialize(
            test_member_move_info_payload, components=mock_components
        )
...
class TestUnrecognisedAuditLogEntryInfo:
    ...
    def test_deserialize(self, test_unrecognised_audit_log_entry, mock_components):
        unrecognised_info_obj = audit_logs.UnrecognisedAuditLogEntryInfo.deserialize(
            test_unrecognised_audit_log_entry, components=mock_components
        )
...
class TestAuditLogEntry:
    def test_deserialize_with_options_and_target_id_and_known_type(
        ...
        audit_log_entry_obj = audit_logs.AuditLogEntry.deserialize(
            test_audit_log_entry_payload, components=mock_components
        )
        assert audit_log_entry_obj._components is mock_components
        ...
        assert audit_log_entry_obj.options._components is mock_components
    ...
    def test_deserialize_with_known_type_without_options_or_target_(
        self, test_audit_log_entry_payload, test_audit_log_change_payload, mock_components
    ):
...
class TestAuditLog:
    ...
    def test_deserialize(
        ...
        with stack:
            audit_log_obj = audit_logs.AuditLog.deserialize(test_audit_log_payload, components=mock_components)
            webhooks.Webhook.deserialize.assert_called_once_with(test_webhook_payload, components=mock_components)
            users.User.deserialize.assert_called_once_with(test_user_payload, components=mock_components)
            guilds.PartialGuildIntegration.deserialize.assert_called_once_with(
                test_integration_payload, components=mock_components
            )
...
class TestAuditLogIterator:
    @pytest.mark.asyncio
    async def test__fill_when_entities_returned(self, mock_components):
        ...
        with stack:
            ...
            users.User.deserialize.assert_called_once_with(mock_user_payload, components=mock_components)
            webhooks.Webhook.deserialize.assert_called_once_with(mock_webhook_payload, components=mock_components)
            guilds.PartialGuildIntegration.deserialize.assert_called_once_with(
                mock_integration_payload, components=mock_components
            )
    ...
    @pytest.mark.asyncio
    async def test__fill_when_resource_exhausted(self, mock_components):
        mock_request = mock.AsyncMock(
    ...
    @pytest.mark.asyncio
    async def test__fill_when_before_and_limit_not_set(self, mock_components):
        mock_request = mock.AsyncMock(
            return_value={
                "webhooks": [],
                "users": [],
    ...
    @pytest.mark.asyncio
    async def test__fill_when_before_and_limit_set(self, mock_components):
        mock_request = mock.AsyncMock(
            return_value={
                "webhooks": [],
                "users": [],
    ...
    @pytest.mark.asyncio
    async def test___anext___when_not_filled_and_resource_is_exhausted(self, mock_components):
        mock_request = mock.AsyncMock(
            return_value={"webhooks": [], "users": [], "audit_log_entries": [], "integrations": []}
        )
    ...
    @pytest.mark.asyncio
    async def test___anext___when_not_filled(self, mock_components):
        mock_request = mock.AsyncMock(
        ...
        with mock.patch.object(audit_logs.AuditLogEntry, "deserialize", side_effect=[mock_audit_log_entry]):
            async for result in iterator:
                ...
                break
            audit_logs.AuditLogEntry.deserialize.assert_called_once_with({"id": "666666"}, components=mock_components)
        mock_request.assert_called_once_with(
            before="123", limit=100,
        )
    ...
    @pytest.mark.asyncio
    async def test___anext___when_not_filled_and_limit_exhausted(self, mock_components):
        mock_request = mock.AsyncMock(
    ...
    async def test___anext___when_filled(self, mock_components):
        ...
        with mock.patch.object(audit_logs.AuditLogEntry, "deserialize", side_effect=[mock_audit_log_entry]):
            async for result in iterator:
                assert result is mock_audit_log_entry
                break
            audit_logs.AuditLogEntry.deserialize.assert_called_once_with({"id": "123123"}, components=mock_components)
