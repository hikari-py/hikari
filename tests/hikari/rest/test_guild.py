...
class TestMemberPaginator:
    ...
    def test_init_no_start_bounds(self, mock_session, mock_app):
        guild = mock.MagicMock(__int__=lambda _: 22)
        pag = _guild._MemberPaginator(mock_app, guild, None, mock_session)
    ...
    def test_init_with_start_bounds(self, mock_session, mock_app, start_at, expected):
        guild = mock.MagicMock(__int__=lambda _: 25)
        pag = _guild._MemberPaginator(mock_app, guild, start_at, mock_session)
    ...
    @pytest.mark.asyncio
    async def test_next_chunk_performs_correct_api_call(self, mock_session, mock_app, member_cls):
    ...
    @pytest.mark.asyncio
    async def test_next_chunk_when_empty_returns_None(self, mock_session, mock_app, member_cls):
    ...
    @pytest.mark.asyncio
    async def test_next_chunk_updates_first_id_to_last_item(self, mock_session, mock_app, member_cls):
        return_payload = [
            {"id": "1234", ...: ...},
            {"id": "3456", ...: ...},
            {"id": "3333", ...: ...},
    ...
    @pytest.mark.asyncio
    async def test_next_chunk_deserializes_payload_in_generator_lazily(self, mock_session, mock_app, member_cls):
        ...
        for i, input_payload in enumerate(return_payload):
            ...
            member_cls.deserialize.assert_called_with(input_payload, app=mock_app)
...
class TestRESTGuildLogic:
    ...
    async def test_fetch_audit_log_entries_before_with_optionals_integration(
        ...
        with mock.patch.object(audit_logs.AuditLogEntry, "deserialize", return_value=mock_entry):
            ...
            audit_logs.AuditLogEntry.deserialize.assert_called_once_with(
                mock_entry_payload, app=rest_guild_logic_impl._app
            )
    ...
    async def test_fetch_audit_log_with_optionals(self, rest_guild_logic_impl, guild, user, before):
        ...
        with mock.patch.object(audit_logs.AuditLog, "deserialize", return_value=mock_audit_log_obj):
            ...
            audit_logs.AuditLog.deserialize.assert_called_once_with(
                mock_audit_log_payload, app=rest_guild_logic_impl._app
            )
    ...
    async def test_fetch_guild_emoji(self, rest_guild_logic_impl, guild, emoji):
        ...
        with mock.patch.object(emojis.KnownCustomEmoji, "deserialize", return_value=mock_emoji_obj):
            ...
            emojis.KnownCustomEmoji.deserialize.assert_called_once_with(
                mock_emoji_payload, app=rest_guild_logic_impl._app
            )
    ...
    async def test_create_guild_with_optionals(self, rest_guild_logic_impl, region):
        ...
        with stack:
            ...
            mock_image_obj.read.assert_awaited_once()
            guilds.Guild.deserialize.assert_called_once_with(mock_guild_payload, app=rest_guild_logic_impl._app)
    ...
    async def test_fetch_guild_preview(self, rest_guild_logic_impl, guild):
        ...
        with mock.patch.object(guilds.GuildPreview, "deserialize", return_value=mock_guild_preview_obj):
            ...
            guilds.GuildPreview.deserialize.assert_called_once_with(
                mock_guild_preview_payload, app=rest_guild_logic_impl._app
            )
    ...
    async def test_fetch_guild_channels(self, rest_guild_logic_impl, guild):
        ...
        with mock.patch.object(channels, "deserialize_channel", return_value=mock_channel_obj):
            ...
            channels.deserialize_channel.assert_called_once_with(mock_channel_payload, app=rest_guild_logic_impl._app)
    ...
    async def test_fetch_member(self, rest_guild_logic_impl, guild, user):
        ...
        with mock.patch.object(guilds.GuildMember, "deserialize", return_value=mock_member_obj):
            ...
            guilds.GuildMember.deserialize.assert_called_once_with(mock_member_payload, app=rest_guild_logic_impl._app)
    ...
    def test_fetch_members(self, rest_guild_logic_impl):
        ...
        init.assert_called_once_with(
            guild=guild, created_after=None, app=rest_guild_logic_impl._app, session=rest_guild_logic_impl._session,
        )
    ...
    async def test_fetch_ban(self, rest_guild_logic_impl, guild, user):
        ...
        with mock.patch.object(guilds.GuildMemberBan, "deserialize", return_value=mock_ban_obj):
            ...
            guilds.GuildMemberBan.deserialize.assert_called_once_with(mock_ban_payload, app=rest_guild_logic_impl._app)
    ...
    async def test_fetch_guild_voice_regions(self, rest_guild_logic_impl, guild):
        ...
        with mock.patch.object(voices.VoiceRegion, "deserialize", return_value=mock_voice_obj):
            ...
            voices.VoiceRegion.deserialize.assert_called_once_with(mock_voice_payload, app=rest_guild_logic_impl._app)
    ...
    async def test_fetch_guild_invites(self, rest_guild_logic_impl, guild):
        ...
        with mock.patch.object(invites.InviteWithMetadata, "deserialize", return_value=mock_invite_obj):
            ...
            invites.InviteWithMetadata.deserialize.assert_called_once_with(
                mock_invite_payload, app=rest_guild_logic_impl._app
            )
    ...
    async def test_fetch_integrations(self, rest_guild_logic_impl, guild):
        ...
        with mock.patch.object(guilds.GuildIntegration, "deserialize", return_value=mock_integration_obj):
            ...
            guilds.GuildIntegration.deserialize.assert_called_once_with(
                mock_integration_payload, app=rest_guild_logic_impl._app
            )
    ...
    async def test_fetch_guild_embed(self, rest_guild_logic_impl, guild):
        ...
        with mock.patch.object(guilds.GuildEmbed, "deserialize", return_value=mock_embed_obj):
            ...
            guilds.GuildEmbed.deserialize.assert_called_once_with(mock_embed_payload, app=rest_guild_logic_impl._app)
    ...
    async def test_fetch_guild_vanity_url(self, rest_guild_logic_impl, guild):
        ...
        with mock.patch.object(invites.VanityUrl, "deserialize", return_value=mock_vanity_obj):
            ...
            invites.VanityUrl.deserialize.assert_called_once_with(mock_vanity_payload, app=rest_guild_logic_impl._app)
    ...
    async def test_fetch_guild_webhooks(self, rest_guild_logic_impl, channel):
        ...
        with mock.patch.object(webhooks.Webhook, "deserialize", return_value=mock_webhook_obj):
            ...
            webhooks.Webhook.deserialize.assert_called_once_with(mock_webhook_payload, app=rest_guild_logic_impl._app)
