...
class TestMessagePaginator:
    ...
    def test_init_first_id_is_date(self, mock_session, mock_app, direction):
        ...
        channel_id = 1234567
        pag = channel._MessagePaginator(mock_app, channel_id, direction, date, mock_session)
    ...
    def test_init_first_id_is_id(self, mock_session, mock_app, direction):
        expected_id = 115590097100865536
        channel_id = 1234567
        pag = channel._MessagePaginator(mock_app, channel_id, direction, expected_id, mock_session)
        assert pag._first_id == str(expected_id)
        assert pag._channel_id == str(channel_id)
        assert pag._direction == direction
        assert pag._session is mock_session
    ...
    async def test_next_chunk_makes_api_call(self, mock_session, mock_app, message_cls, direction):
        ...
        pag = channel._MessagePaginator(mock_app, channel_obj, direction, "12345", mock_session)
        pag._first_id = "12345"
...
class TestRESTChannel:
    ...
    async def test_fetch_channel(self, rest_channel_logic_impl, channel):
        ...
        with mock.patch.object(channels, "deserialize_channel", return_value=mock_channel_obj):
            ...
            channels.deserialize_channel.assert_called_once_with(mock_payload, app=rest_channel_logic_impl._app)
    ...
    def test_fetch_messages(self, rest_channel_logic_impl, direction, expected_direction, first, expected_first):
        ...
        init.assert_called_once_with(
            ...
            app=rest_channel_logic_impl._app,
    ...
    async def test_fetch_message(self, rest_channel_logic_impl, channel, message):
        ...
        with mock.patch.object(messages.Message, "deserialize", return_value=mock_message_obj):
            ...
            messages.Message.deserialize.assert_called_once_with(mock_payload, app=rest_channel_logic_impl._app)
    ...
    async def test_create_message_with_optionals(self, rest_channel_logic_impl, channel):
        ...
        with stack:
            ...
            messages.Message.deserialize.assert_called_once_with(mock_message_payload, app=rest_channel_logic_impl._app)
    ...
    async def test_fetch_invites_for_channel(self, rest_channel_logic_impl, channel):
        ...
        with mock.patch.object(invites.InviteWithMetadata, "deserialize", return_value=mock_invite_obj):
            ...
            invites.InviteWithMetadata.deserialize.assert_called_once_with(
                mock_invite_payload, app=rest_channel_logic_impl._app
            )
    ...
    async def test_create_webhook_with_optionals(self, rest_channel_logic_impl, channel):
        ...
        with stack:
            ...
            webhooks.Webhook.deserialize.assert_called_once_with(mock_webhook_payload, app=rest_channel_logic_impl._app)
