...
Discord application **tokens** are supposed to be **stored securely**. Earlier we mentioned to note our application token somewhere, and pasting in our `main.py` file for access in the program is dangerous and unsecure.
