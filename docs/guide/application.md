...
A Discord application is the foundational application that Discord bots (or any Discord app) run as.
Each application has a token that is used to identify with Discord's gateway when we wish to connect (like a password).

We need to create our application (bot user), set its intents, permissions (if required), and get the token.
...
![Application Name and Team](../assets/guide/application/create-app-name-team.png "Application Name and Team")
...
![Installation Contexts](../assets/guide/application/installation/installation-contexts.png "Installation Contexts")
...
![Default Install Settings](../assets/guide/application/installation/default-install-settings.png "Default Install Settings")
...
![Install Link](../assets/guide/application/installation/install-link.png "Install Link")

Once the bot has been invited to our server, we can see it in the `Offline` section of our member list.

![Offline Discord Bot](../assets/guide/application/installation/offline-bot.png "Offline Discord Bot")
...
![Authorization Flow](../assets/guide/application/bot/authorization-flow.png "Authorization Flow")
