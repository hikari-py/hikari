...
def test_AuditLog_has_three_specified_keys(audit_log_object):
...
def test_AuditLog_has_correct_number_of_users(audit_log_object):
...
def test_AuditLog_has_correct_number_of_webhooks(audit_log_object):
    assert len(audit_log_object.webhooks) == 1
    assert audit_log_object.webhooks[0] is not None


def test_AuditLog_has_correct_number_of_entries(audit_log_object):
    assert len(audit_log_object.entries) == 8
    for number, entry in enumerate(audit_log_object.entries, start=1):
        assert entry is not None


def test_AuditLogEntry_edit_channel(audit_log_entry_edit_channel):
...
def test_AuditLogEntry_invite_create(audit_log_entry_invite_create):
...
def test_AuditLogEntry_message_delete(audit_log_entry_message_delete):
...
def test_AuditLogEntry_overwrites_add(audit_log_entry_overwrites_add):
...
def test_AuditLogEntry_overwrites_update(audit_log_entry_overwrites_update):
...
def test_AuditLogEntry_overwrites_delete(audit_log_entry_overwrites_delete):
...
def test_AuditLogEntry_role_add_to_member(audit_log_entry_role_add):
...
def test_AuditLogEntry_role_remove_from_member(audit_log_entry_role_remove):
...
def test_AuditLogChangeKey_handles_undocumented_crap_input():
